...
export const themes: Record<string, Theme> = {
  ...
  'monochrome-light': {
    ...
    colors: {
      ...
      surface: 'rgba(30, 41, 59, 0.08)',
      text: '#0f172a',
      textSecondary: '#475569',
      border: 'rgba(30, 41, 59, 0.15)',
      gradient: 'linear-gradient(135deg, #1e293b 0%, #334155 50%, #0ea5e9 100%)',
      primaryShadow: 'rgba(30, 41, 59, 0.25)',
      primaryShadowStrong: 'rgba(30, 41, 59, 0.4)',
    },
    fonts: {
      heading: 'Inter, sans-serif',
      body: 'Inter, sans-serif',
    ...
    effects: {
      glass: 'backdrop-filter: blur(10px); background: rgba(248, 250, 252, 0.85);',
      shadow: '0 8px 32px rgba(30, 41, 59, 0.15)',
      blur: 'blur(10px)',
    },
  },
